...
import DemoPropietarioSidebarNav from './DemoPropietarioSidebarNav'
import PropietarioUserInfo from '../PropietarioUserInfo'

interface DemoPropietarioMobileSidebarProps {
  user: {
    name: string
    email: string
  }
...
export default function DemoPropietarioMobileSidebar({ user }: DemoPropietarioMobileSidebarProps) {
